                ...
                <View style={{marginHorizontal : 20 , marginTop : -50 , padding : 20, borderWidth : 1, borderColor : 'gray', borderRadius : 20, backgroundColor : 'white'}}>
                    ...
                    <View style={{ flexDirection : "row", marginTop : 10 , justifyContent : "space-around" }}>
                        <View style={{alignItems: 'center'}}>
                            <MaterialCommunityIcons name="noodles" size={20} color="black" />    
                            <Text style={{paddingTop: 5}}>Noodles</Text>
                        </View>

                        <View style={{alignItems: 'center'}}>
                            <FontAwesome6 name="bowl-rice" size={20} color="black" />
                    ...
                    <View style={{ flexDirection : "row", marginTop : 10 , justifyContent : "space-around" }}>
                        ...
                        <View style={{alignItems: 'center'}}>
                            <MaterialCommunityIcons name="fruit-citrus" size={20} color="black" />
